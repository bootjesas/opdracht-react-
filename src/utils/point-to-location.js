...
dus dat bericht moet by default verborgen zijn. (vandaar dat het voorbeeld al meteen onHideRequestPermissions() oproept ook)
...
import { getDistance } from './_getDistance';
const isIOS = false;
